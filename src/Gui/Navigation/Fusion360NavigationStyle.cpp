...
/* TRANSLATOR Gui::Fusion360NavigationStyle */

TYPESYSTEM_SOURCE(Gui::Fusion360NavigationStyle, Gui::UserNavigationStyle)

Fusion360NavigationStyle::Fusion360NavigationStyle()
    : lockButton1(false)
{}

Fusion360NavigationStyle::~Fusion360NavigationStyle() = default;

const char* Fusion360NavigationStyle::mouseButtons(ViewerMode mode)
{
    switch (mode) {
...
std::string Fusion360NavigationStyle::userFriendlyName() const
{
    return {"Fusion 360"};
}

SbBool Fusion360NavigationStyle::processSoEvent(const SoEvent* const ev)
{
    ...
    switch (combo) {
        ...
        default:
            ...
            // This stops the PANNING when button 3 is released
            ...
            if ((curmode == NavigationStyle::PANNING || curmode == NavigationStyle::DRAGGING
