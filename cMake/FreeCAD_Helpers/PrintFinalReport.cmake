macro(PrintFinalReport)
    ...
    simple(Coin3D_Source ${FREECAD_COIN3D_SOURCE})
    conditional(TBB TBB_FOUND "not found" "${TBB_VERSION}")
    if(DEFINED FREECAD_COIN_EXPAT_SOURCE)
        simple(Coin3D_Expat ${FREECAD_COIN_EXPAT_SOURCE})
    endif()
    simple(pivy ${PIVY_VERSION})
    simple(pivy_Source ${FREECAD_PIVY_SOURCE})
    if(WIN32 OR APPLE)
